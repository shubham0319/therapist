...
type dbHelper interface {
	...
	ToggleUserBlogLike(ctx context.Context, blogID, userID pgtype.UUID) (bool, int64, error)
	IsUserBlogLikedBy(ctx context.Context, blogID, userID pgtype.UUID) (bool, error)
	...
	GetTherapistCardByID(ctx context.Context, id pgtype.UUID) (schema.TherapistCardRow, error)
}
